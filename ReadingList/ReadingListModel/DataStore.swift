...
public let defaultStoreName = "ReadingList"
...
public final class DataStore
{
    ...
    public init(storeName: String = defaultStoreName, bundle: Bundle = Bundle.main) {
...
extension DataStore {
    ...
    public func save(readingList: ReadingList) throws {
